...
def main():
    try:
        df = pd.read_csv('data/qqq/'+ticker+'.txt', parse_dates=True, index_col='Date')
...
signbuytojson.to_json("qqqsignbuy.json",orient="index")
...
signselltojson.to_json("qqqsignsell.json",orient="index")



print("qqq json loaded")
...
# ### initiate_data_qqq
# # symbols = ",".join(symbols) (no running)
...
#         signbuy.loc[i].to_json('b.json',orient="index")
#     except:
#         pass
# # sign    
