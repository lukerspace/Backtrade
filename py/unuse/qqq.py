...
signbuytojson.to_json("./json/qqqsignbuy.json",orient="index")
...
signselltojson.to_json("./json/qqqsignsell.json",orient="index")
...
histable.to_json("./json/qqqhist.json",orient="index")    
