...
signbuytojson.to_json("./json/spysignbuy.json",orient="index")
...
signselltojson.to_json("./json/spysignsell.json",orient="index")
...
histable.to_json("./json/spyhist.json",orient="index")    
